  ...
  return (
    <div className="min-h-screen bg-toss-gray-50">
      <div className="px-5 pt-14 pb-4 flex items-end justify-between bg-white">
        <div>
          <h1 className="toss-title text-[26px]">⚽ 득점왕</h1>
          <p className="toss-caption mt-1">K리그1 득점 순위 TOP 30</p>
        </div>
        <button
          onClick={load}
      ...
      {!loading && players.length === 0 && (
        <div className="px-5 py-10 text-center">
          <p className="text-toss-gray-500">아직 득점 순위 데이터가 없어요</p>
        </div>
      )}
              ...
              return (
                <div key={`${p.name}-${idx}`}>
                  ...
                  >
                    ...
                    <span className="text-right text-sm text-toss-gray-600 tabular-nums">{p.assists}</span>
